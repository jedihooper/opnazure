...
|--------|--------|--------|
| BicepBuild | [bicepBuild.yml](./.github/workflows/bicepBuild.yml) | [![bicepBuildCI](https://github.com/jedihooper/opnazure/actions/workflows/bicepBuild.yml/badge.svg?branch=dev)](https://github.com/jedihooper/opnazure/actions/workflows/bicepBuild.yml) |
| Deployment Checker - Active Active | [deploymentChecker-active-active.yml](./.github/workflows/deploymentChecker-active-active.yml) | [![deploymentCheckeractiveactiveactiveCI](https://github.com/jedihooper/opnazure/actions/workflows/deploymentChecker-active-active.yml/badge.svg?branch=master)](https://github.com/jedihooper/opnazure/actions/workflows/deploymentChecker-active-active.yml) |
| Deployment Checker - two nics | [deploymentChecker-two-nics.yml](./.github/workflows/deploymentChecker-two-nics.yml) | [![deploymentCheckertwonicsCI](https://github.com/jedihooper/opnazure/actions/workflows/deploymentChecker-two-nics.yml/badge.svg?branch=master)](https://github.com/jedihooper/opnazure/actions/workflows/deploymentChecker-two-nics.yml) |
...
| Deployment Checker - new vnet two nics | [deploymentChecker-newvnet-two-nics.yml](./.github/workflows/deploymentChecker-two-nics.yml) | [![deploymentCheckernewvnettwonicsCI](https://github.com/jedihooper/opnazure/actions/workflows/deploymentChecker-newvnet-two-nics.yml/badge.svg?branch=master)](https://github.com/jedihooper/opnazure/actions/workflows/deploymentChecker-newvnet-two-nics.yml) |

**Deployment Wizard**

[![Deploy To Azure](https://raw.githubusercontent.com/Azure/azure-quickstart-templates/master/1-CONTRIBUTION-GUIDE/images/deploytoazure.svg?sanitize=true)](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2Fjedihooper%2Fopnazure%2Fmaster%2FARM%2Fmain.json%3F/uiFormDefinitionUri/https%3A%2F%2Fraw.githubusercontent.com%2Fjedihooper%2Fopnazure%2Fmaster%2Fbicep%2FuiFormDefinition.json)
...
OPNSense is based on FreeBSD which is the official OS image publisher in Azure. This template deploys a FreeBSD 15.0 VM and installs OPNSense using the opnsense-bootstrap installation method. For the first deployment in an Azure Subscription it's ***required to accept the legal terms*** of the Offer with PublisherId: 'freebsd', OfferId: 'freebsd-15_0'.

You can accept it using either Azure CLI or Azure PowerShell as follow:

```bash
az vm image terms accept --urn freebsd:freebsd-15_0:15_0-release-amd64-gen2-zfs:latest -o none
```

```powershell
Get-AzMarketplaceTerms -Publisher 'freebsd' -Product 'freebsd-15_0' -Name '15_0-release-amd64-gen2-zfs' -OfferType 'latest' | Set-AzMarketplaceTerms -Accept
```
...
Please use Github [issues tab](https://github.com/jedihooper/opnazure/issues) to provide feedback.
